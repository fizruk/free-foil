...
module Language.SOAS.Syntax.Lex where
...
-- token OpIdent
$c ([\' \_]| ($d | $l)) *
    { tok (eitherResIdent T_OpIdent) }

-- token MetaVarIdent
\? ([\' \_]| ($d | $l)) *
    { tok (eitherResIdent T_MetaVarIdent) }
...
resWords =
  b "]" 8
    (b "." 4
       ...
       (b "=" 6 (b ":" 5 N N) (b "[" 7 N N)))
    (b "\8614" 12
       (b "\215" 10 (b "|" 9 N N) (b "\8594" 11 N N))
       (b "\8866" 14 (b "\8704" 13 N N) N))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
